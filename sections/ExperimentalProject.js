    ...
    >
      ...
      >
        <div className="flex flex-col justify-center  pl-[4rem] lg:pl-[7rem] ">
          <span className="text-customOrange flex items-center gap-x-2 text-sm font-bold uppercase font2 relative ">
            <motion.div
          ...
          <RevealTitle
            phrases={["I bring joy and creativity", "with every photo"]}
            phraseStyle="text-5xl font-bold leading-[3.5rem]"
          />
          <RevealParagraph
            phrases={[
          ...
          <div className="mt-8 flex items-center justify-between">
            <motion.button
              ...
              className=" py-3 px-6 bg-customYellow  text-sm font2 font-bold uppercase origin-bottom"
            >
              <motion.div
        ...
        <div className="flex flex-col justify-end items-center">
          <div className="relative w-[25rem] md:h-[90%] xl:h-[85%] rounded-t-full">
            ...
            >
              <RevealTitle
                phrases={["Drag to view", "more"]}
                phraseStyle="text-center font2 text-sm font-semibold uppercase"
              />
            </motion.div>
          </div>
        </div>
